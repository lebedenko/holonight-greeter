...
int main(int argc, char **argv) {
  ...
  qputenv("DBUS_SESSION_BUS_ADDRESS", "unix:path=/nonexistent/uqc106-bus");
  qputenv("DBUS_SYSTEM_BUS_ADDRESS", "unix:path=/nonexistent/uqc106-bus");
  qputenv("GREETD_SOCK", "/nonexistent/uqc106-greetd");
  qputenv("PATH", isolation.path().toUtf8());
