...
Greeter has a compact QML module and explicit binaries/assets/tmpfiles metadata. It correctly exposes system installation only, but QML is top-level and direct install currently provisions tmpfiles itself.
