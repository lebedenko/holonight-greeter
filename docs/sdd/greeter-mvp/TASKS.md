...
| HGR-101-TEST | Done | Domain, controller, fragmented/coalesced transport, power-gating, deterministic scenario behavior, and the four documented offscreen demo commands pass. |
...
QML cache/type compilation, four offscreen demo scenarios, and temporary-prefix CMake install inspection passed. The
