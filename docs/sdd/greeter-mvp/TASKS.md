...
| HGR-101-INSTALL | Done | CMake installs config, wallpaper, account faces, tmpfiles, and documentation into a chosen prefix; the fallback avatar remains bundled and distribution packaging is deferred to release planning. |
